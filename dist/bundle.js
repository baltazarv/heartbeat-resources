...
var Nav = function Nav() {
  return _react2.default.createElement(
    'a',
    { href: '/auth/google' },
    'Sign In to Google Account to Access Resourcing Sheet'
  );
};
...
var Main = function (_Component) {
  ...
  _createClass(Main, [{
    key: 'onGetData',
    value: function onGetData(ev) {
      console.log('get data');
    }
  }, {
    key: 'render',
    value: function render() {
      return _react2.default.createElement(_Main, { onGetData: this.onGetData });
    }
  }]);
...
var _Main = function _Main(_ref) {
  var onGetData = _ref.onGetData;
